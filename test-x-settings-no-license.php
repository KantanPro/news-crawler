...
if (class_exists('NewsCrawler_License_Manager')) {
    ...
    // X投稿設定の表示判定をテスト
    echo "\n=== X投稿設定表示判定 ===\n";
    echo "X投稿設定フォーム: 表示（開発段階の機能のためライセンス不要）\n";
    echo "ライセンス通知: 非表示（X投稿機能は開発段階のため）\n";
}
...
echo "\nテスト完了。\n";
echo "期待される動作:\n";
echo "- X投稿設定: ライセンス不要で常に表示（開発段階の機能）\n";
echo "- 自動投稿設定メニュー: ライセンスが必要（本格的な自動投稿機能）\n";
?>
