...
[![Version](https://img.shields.io/badge/version-2.1.1-blue.svg?style=flat-square)](https://github.com/KantanPro/news-crawler/releases/tag/v2.1.1)
...
- **v2.1.1** (2025-08-31): Plugin stability and documentation improvements
  - Enhanced plugin stability and performance
  - Updated changelog organization and documentation
  - Improved overall plugin quality and maintainability
- **v2.1.0** (2025-08-31): Enhanced category preservation and content processing
  - Added functionality to save and restore post categories during processing
  - Categories are now preserved during OpenAI summary generation and SEO title generation
  - Further improved plugin stability and user experience
