...
[![Version](https://img.shields.io/badge/version-2.3.53-blue.svg?style=flat-square)](https://github.com/KantanPro/news-crawler/releases/tag/v2.3.53)
...
- **v2.3.53** (2025-09-09): Major security enhancements and evaluation value management improvements
  - Implemented OpenAI API key encryption functionality with security manager for secure management
  - Added automatic migration functionality to encrypt existing plaintext API keys
  - Implemented API key mask display in settings screen for enhanced security
  - Added evaluation value cache invalidation functionality on post deletion and status changes
  - Implemented post-creation evaluation value restoration and backup functionality
  - Added post creation status specification functionality for flexible post management
  - Significantly improved security and data management reliability
